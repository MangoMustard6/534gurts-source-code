    ...
    fields: [
      ...
      },
      {
        ...
        value: [
          ...
          '`th/preview1280 [start] [dur] [r3]` *p1280* — 12-segment TV-simulator montage; add `r3` for native Rubber Band R3 pitches',
          '`th/oppositep1280 [start] [dur] [r3]` *op1280* — Inverse TV-simulator montage; add `r3` for native Rubber Band R3 pitches',
          '`th/preview1280with640x360resize [start] [dur] [r3]` *p1280ff!3* — preview1280 locked to 640×360; add `r3` for native Rubber Band R3 pitches',
          '`th/preview1280what [s] [dur] [len] [tempo] [r3]` *p1280what p1280fev8v2plus* — **28-segment** extended montage (v8 v2+); pass `true` for tempo-stretch or `r3` for native Rubber Band R3 pitches',
