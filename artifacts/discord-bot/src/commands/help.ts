    ...
    fields: [
      ...
      },
      {
        ...
        value: [
          ...
          '`th/preview1280 [start] [dur] [true|false]` *p1280* — 12-segment montage; boolean selects native Rubber Band R3 (`true`) or FFmpeg Rubber Band (`false`)',
          '`th/oppositep1280 [start] [dur] [true|false]` *op1280* — Inverse montage; boolean selects native Rubber Band R3 (`true`) or FFmpeg Rubber Band (`false`)',
          '`th/preview1280with640x360resize [start] [dur] [true|false]` *p1280ff!3* — 640×360 montage; boolean selects native R3 or FFmpeg Rubber Band',
          '`th/preview1280what [s] [dur] [true|false] [len] [tempo]` *p1280what p1280fev8v2plus* — **28-segment** montage; boolean after duration selects R3, later boolean enables tempo-stretch',
